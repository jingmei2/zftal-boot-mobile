 ...
 * generated in the com.zfsoft.newmobile.login.CXFService package.
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zfsoft.newmobile.login.CXFService
     *
     */
