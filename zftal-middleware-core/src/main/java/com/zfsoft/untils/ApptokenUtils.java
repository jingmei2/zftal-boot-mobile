...
public class ApptokenUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("?username="+java.net.URLEncoder.encode(com.zfsoft.untils.CodeUtil.encode(username, apptoken),"utf-8")+"&schoolNumber="+java.net.URLEncoder.encode(com.zfsoft.untils.CodeUtil.encode(schoolNumber, apptoken), "utf-8")+"&dataType="+java.net.URLEncoder.encode(com.zfsoft.untils.CodeUtil.encode(dataType, apptoken), "utf-8")+"&apptoken="+apptoken);
