...
public class PageHtml {
	...
	private String pageLeft(){
		...
		sb.append("第<input id='toPage' type='text' name='"+getPrefix()+"toPage' style='color:red; text-align:center;width:20px;' value='"+paginator.getPage()+"' size='2' "
				+initPageInput()+" title='页码,可修改,回车跳转'>页 / 共");
        sb.append("<span class='red' id='totalPage'>"+paginator.getPages()+"</span>页， 每页显示");
        sb.append("<input type='text' id='pageSize' name='"+getPrefix()+"perPageSize' style='width:20px;' value='"
