...
public class Struts2Utils {
	...
	protected static Log logger = LogFactory.getLog(Struts2Utils.class);
	...
	/**
	 *  得到request中参数Map,相当于request.getParameterMap()
	 */
	...
	/**
	 * 得到Context中的变量,相当于request.getAttribute()
	 */
	...
	/**
	 * 得到Application中的变量Map,相当于request.getSession().getServletContext().getAttribute()
	 */
