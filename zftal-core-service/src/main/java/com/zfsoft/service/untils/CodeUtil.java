...
//			System.out.print("?username="+ URLEncoder.encode(username, "utf-8"));
//			System.out.print("&start="+ URLEncoder.encode(start, "utf-8"));
//			System.out.print("&size="+ URLEncoder.encode(size, "utf-8"));
//			System.out.print("&status="+ URLEncoder.encode(status, "utf-8"));
//			System.out.print("&haveEvaluate="+ URLEncoder.encode(haveEvaluate, "utf-8"));
...
//			System.out.println(URLEncoder.encode("tsmf92e/7b7bhYFjt+jQ7w==", "utf-8"));
//
//			//System.out.println(decode("9sJ2qag3wxkuPfJ7yTDViJ+Y60A4RnMl", "ZF"));
//			System.out.println(ttt);
//			System.out.println(URLEncoder.encode(CodeUtil.encode("459", "54bcd0a3f2f1bc366a352d0e05f88990"),"utf-8"));
//    	} catch (Exception e) {
//			e.printStackTrace();
//		}
//    }
