package com.zfsoft.hrm.manoeuvre.configInfo.util;
...
public class AuditConfigOrgUtil {

	public static String getConfigListHtml(String parentId, int deep, List<String> codeIdList, HashSet<String> orgSet){
		...
		for(Item item : list){
			...
			sb.append("</tr>");
			if(item.getHasChild()){
				sb.append(getConfigListHtml(item.getGuid(), deep+1, codeIdList, orgSet));
			}
